  ...
  return (
    <nav className="w-full bg-white shadow-md px-6 py-3 flex items-center justify-between">
      ...
      <div className="hidden md:flex gap-6 text-gray-700">
        <Link className="hover:text-purple-800" href="/dashboard">Home</Link>
        <Link className="hover:text-purple-800" href="/aboutUs">About Us</Link>
        <Link className="hover:text-purple-800" href="/pricing">Pricing</Link>
      </div>
