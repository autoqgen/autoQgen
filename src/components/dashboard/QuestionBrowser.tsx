    ...
    <div className="flex flex-col gap-6">
      <header>
        ...
        <p className="mt-1 text-sm text-slate-500">
          Browse the question bank. Answer keys are shown only to roles permitted to see them.
        </p>
      </header>
      ...
      <Card>
        ...
        {loading ? (
          ...
          <EmptyState
            ...
            body="Adjust the filters, or seed the database with the development seed script."
          />
        ) : (
